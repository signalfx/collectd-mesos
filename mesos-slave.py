...
STATS_MESOS = {
    ...
    'slave/recovery_errors': Stat("gauge", "slave/recovery_errors"),
    'slave/registered': Stat("gauge", "slave/registered"),
    'slave/tasks_failed': Stat("gauge", "slave/tasks_failed"),
    'slave/tasks_finished': Stat("gauge", "slave/tasks_finished"),
    'slave/tasks_killed': Stat("gauge", "slave/tasks_killed"),
    'slave/tasks_lost': Stat("gauge", "slave/tasks_lost"),
    ...
    'slave/valid_framework_messages': Stat("gauge", "slave/valid_framework_messages"),
    'slave/valid_status_updates': Stat("gauge", "slave/valid_status_updates"),
    ...
    'system/mem_free_bytes': Stat("gauge", "system/mem_free_bytes"),
    'system/mem_total_bytes': Stat("gauge", "system/mem_total_bytes")
}
...
STATS_MESOS_020 = {
    ...
    'slave/executors_terminated': Stat("gauge", "slave/executors_terminated"),
